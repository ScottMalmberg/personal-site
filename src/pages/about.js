...
export default () => 
    ...
    <Layout background="url('/images/Fam.JPG')">
        ...
        <p>
            ...
            I started diving into automation, using tools like Zapier and Infusionsoft to help streamline my client's business processes. I was hooked.
        </p>
        <p>
            From there, I got into web design. This started with WordPress themes and moved to using builders like Thrive Architect to customize pages/sites from scratch. 
            While learning what goes into making a good webpage, I started teaching myself HTML, CSS, and JavaScript through FreeCodeCamp.
        </p>
        <p>
        ...
        <p>
            ...
            I've played guitar since I was 9 years old, and have since picked up a variety of other instruments. 
            I also love to cook, bake, and eat. My dream is to live on a solar-powered farm growing fresh fruit and vegetables.
        </p>
    </Layout>
